                ...
                if clientAddress != nil {
                    ...
                    switch value {
                        case ChatMessage.Who:
                            ...
                            withUnsafeBytes(of: ChatMessage.WhoResponse) { sendBuffer.append(contentsOf: $0) }
                            var list = activeClients.whoResponse()
                            //print(list)
                            
                            withUnsafeBytes(of: list.count) { sendBuffer.append(contentsOf: $0) }
                            for client in list {
                                client.nickname.utf8CString.withUnsafeBytes { sendBuffer.append(contentsOf: $0) }
                            ...
                            do {
                                ...
                                print("Error al mandar WhoResponse")
